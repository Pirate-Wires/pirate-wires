    ...
    <>
      ...
      <nav className={`${styles.megaNav} unprepped`} id="mega-nav">
        <button className={`${styles.closeNav} close-trigger hitbox`}>
          <svg
            ...
            <rect
              ...
              width="20"
              height="2"
              transform="rotate(45 1.63306 0.00151062)"
              fill="#1C1C1C"
            />
            <rect
              x="0.218994"
              ...
              width="20"
              height="2"
              transform="rotate(-45 0.218994 14.1421)"
              fill="#1C1C1C"
            />
          </svg>
        </button>
        ...
        <div className={`${styles.middle} fade-el`}>
          <Link className="nav-link" href="/wires">
            Pirate Wires
          </Link>
          <Link className="nav-link" href="/white-pill">
            The White Pill
          </Link>
          <Link className="nav-link" href="/the-industry">
            The Industry
          </Link>
          <Link className="nav-link" href="/dolores-park">
            Dolores Park
          </Link>
        </div>
        ...
        <div className={styles.socialRow}>
          <a
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg">
              <path
                d="M10.2954 0.862915H12.2915L7.93168 5.87948L13.0794 12.6821H9.03476L5.8831 8.55849L2.25869 12.6821H0.262638L4.9376 7.32405L0 0.862915H4.14969L7.01245 4.64504L10.2954 0.862915ZM9.5863 11.4739H10.6894L3.54562 1.9923H2.33748L9.5863 11.4739Z"
                fill="#1C1C1C"
              />
            </svg>
          </a>
          ...
          <a
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg">
              <path
                d="M12.7908 6.83014C10.3496 5.38041 6.32294 5.24711 3.99255 5.95439C3.61831 6.06797 3.22256 5.85663 3.1092 5.48251C2.99577 5.10802 3.2068 4.71256 3.58132 4.59879C6.25645 3.78679 10.7035 3.9436 13.5138 5.61183C13.8504 5.81169 13.9608 6.2464 13.7613 6.58243C13.5616 6.91902 13.1265 7.02997 12.7908 6.83014ZM12.7108 8.9774C12.5395 9.25531 12.1762 9.34249 11.8986 9.17183C9.86342 7.92081 6.76006 7.55841 4.35227 8.28929C4.04003 8.38365 3.71023 8.20758 3.61538 7.89594C3.5213 7.5837 3.69744 7.25451 4.00912 7.15955C6.75967 6.3249 10.179 6.72918 12.5166 8.16565C12.7941 8.3366 12.8815 8.70013 12.7108 8.9774ZM11.7841 11.0396C11.648 11.2627 11.3575 11.3327 11.1351 11.1966C9.3567 10.1097 7.11829 9.86428 4.48216 10.4664C4.22813 10.5246 3.97495 10.3654 3.91702 10.1114C3.85884 9.85749 4.01742 9.60428 4.27201 9.54631C7.1568 8.88683 9.63139 9.17066 11.6275 10.3904C11.8501 10.5263 11.9202 10.8171 11.7841 11.0396ZM8.31099 0.116371C4.12848 0.116371 0.737793 3.50699 0.737793 7.68943C0.737793 11.8724 4.12848 15.2627 8.31099 15.2627C12.4936 15.2627 15.8841 11.8724 15.8841 7.68943C15.8841 3.50699 12.4936 0.116371 8.31099 0.116371Z"
                fill="#1C1C1C"
              />
            </svg>
          </a>
