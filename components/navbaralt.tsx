...
export default function NavbarAlt(props) {
  interface MenuItem {
    ...
    title?: string; // Keep title property
    href: string;
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          path: "/post/minimal/state-of-the-union"
        },
        {
              ...
              <div className="flex flex-wrap justify-between md:gap-10 lg:flex-nowrap">
                <div className="flex w-full items-center justify-between lg:w-auto">
                  ...
                  <Disclosure.Button
                    ...
                    className="ml-auto rounded-sm px-2 py-1 text-gray-500 focus:text-blue-500 focus:outline-none dark:text-gray-300 lg:hidden ">
                    <svg
