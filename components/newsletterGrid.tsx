      ...
      <div className={`${styles.inner} c-20`}>
        <div className={styles.top}>
          ...
          <Link
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="17" viewBox="0 0 18 17" fill="none">
              <path d="M0.744407 8.61832H16.6441M16.6441 8.61832L8.69427 0.668457M16.6441 8.61832L8.69427 16.5682" stroke="#E3E3E3" strokeWidth="0.699553" />
            </svg>
          </Link>
        </div>
        ...
        <div className={styles.bottom}>
          <Link
            ...
            <p className={`${styles.title} martina-reg`}>Founder & Writer</p>
          </Link>
          <Link
            href={`/author/author-name`} className="authorTile hasGoIcon">
            <div className={`${styles.imgWrapper} imgWrapper mb-20`}>
