      ...
      >
        <Container>
          <div className="flex flex-col items-start">
            ...
            />
            <p className="mt-1 text-base leading-7 ">{episode.description}</p>
...
export default async function Home() {
  let feed = await parse('https://anchor.fm/s/e160ece4/podcast/rss');
  ...
  return (
    <div className="pb-12 pt-16 sm:pb-4 lg:pt-12">
      <Container>
        <h1 className="text-2xl font-bold leading-7 ">Episodes</h1>
      </Container>
      <div className="divide-y divide-gray-800 sm:mt-4 lg:mt-8 lg:border-t lg:border-gray-100">
