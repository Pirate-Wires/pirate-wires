    ...
    <section className={`${styles.careersPage} c-20`}>
      ...
      <div className={`${styles.careersGrid}`}>
        {pageData.career_list.map((career) => (
          <Link key={career.title} href={career.link} className={`${styles.careerRow} hasGoIcon`}>
            <h3>{career.title}</h3>
      ...
      <div className={`${styles.openCasting} ptb-40`}>
        <h4>Don’t see a job opening that fits you?<br /> Send us an email at <a href="mailto:careers@piratewires.com">careers@piratewires.com</a>
        </h4>
      </div>
    </section>
  );
