        ...
        <div className={styles.portraitWrapper}>
          {authorData.image && (
            <>
              {!loaded && (
                <img
                  src={authorData.image.blurDataURL}
                  alt=""
                  decoding="async"
                  loading="lazy"
              ...
              <picture>
                <source
                  srcSet={`${authorData.image.asset.url}?auto=format&w=600&q=90, ${authorData.image.asset.url}?auto=format&w=800&q=90 2x`}
                  media="(min-width: 768px)"
                />
                <source
                  srcSet={`${authorData.image.asset.url}?auto=format&w=550&q=100`}
        ...
        <div className={styles.singleRight}>
          ...
          <div className={styles.socialRow}>
            ...
            {authorData.social_text_two && (
              <Link
                href={authorData.social_link_two}
                target="_blank"
                className="hasHoverArrow">
                {authorData.social_text_two}
                <span>
            ...
            {authorData.social_text_three && (
              <Link
                href={authorData.social_link_three}
                target="_blank"
                className="hasHoverArrow">
                {authorData.social_text_three}
                <span>
