...
// invokeGuestVote function to suupport guest voting in LikeButton.tsx
export async function invokeGuestVote(
  supabase: any,
  postId: number,
  guestId: string,
  value: number,
...
const VoteButtons = ({
  ...
  // this can serve as a "reporting" function where 
