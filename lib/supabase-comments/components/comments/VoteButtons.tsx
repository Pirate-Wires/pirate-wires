...
import Heart from '@/lib/supabase-comments/icons/Heart';
import ThumbsUpFilled from '@/lib/supabase-comments/icons/ThumbUpFilled';
import ThumbsUpOutlined from '@/lib/supabase-comments/icons/ThumbUpOutlined';
import supabase from '@/lib/supabase-comments/utils/initSupabase';
import type { CommentType } from '@/lib/supabase-comments/utils/types';
