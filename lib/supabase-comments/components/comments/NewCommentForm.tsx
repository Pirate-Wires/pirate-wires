...
import SignInModal from '@/lib/supabase-comments/components/comments/SignInModal';
import User from '@/lib/supabase-comments/icons/User';
import updateFieldHeight from '@/lib/supabase-comments/utils/autosize';
import supabase from '@/lib/supabase-comments/utils/initSupabase';
import punctuationRegex from '@/lib/supabase-comments/utils/regex/punctuationRegex';
...
import { useModal } from '@/lib/supabase-comments/hooks/use-modal';
