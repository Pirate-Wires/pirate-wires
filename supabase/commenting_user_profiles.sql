...
create function public.handle_new_user_profiles()
returns trigger as $$
begin
...
insert into posts (slug, title, content, "authorId", "parentId") values ('threaded-comments-123', 'threaded-comments', 'Threaded comments, built on top of Supabase and Next.js.', '00000000-0000-0000-0000-000000000000'::uuid, 1);
